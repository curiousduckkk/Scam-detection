...
if __name__ == '__main__':
    ...
    for f in valid_files:
        client = TranscriptionClient(
            ...
            output_recording_filename=True,        # Only used for microphone input
            mute_audio_playback=args.mute_audio_playback,      # Only used for file input, False by Default
            enable_translation=True,        # Enable translation of the transcription output
            target_language="en",              # Target language for translation, e.g., "fr
        )
        client(f)
